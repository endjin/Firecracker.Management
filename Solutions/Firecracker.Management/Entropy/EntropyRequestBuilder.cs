...
#nullable enable
        public async Task PutAsync(EntropyDevice body, Action<EntropyRequestBuilderPutRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task PutAsync(EntropyDevice body, Action<EntropyRequestBuilderPutRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPutRequestInformation(EntropyDevice body, Action<EntropyRequestBuilderPutRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public RequestInformation ToPutRequestInformation(EntropyDevice body, Action<EntropyRequestBuilderPutRequestConfiguration> requestConfiguration = default) {
#endif
