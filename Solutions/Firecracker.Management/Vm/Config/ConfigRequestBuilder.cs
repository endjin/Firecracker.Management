...
public class ConfigRequestBuilder : BaseRequestBuilder
{
    ...
    public ConfigRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(
        requestAdapter, "{+baseurl}/vm/config", pathParameters)
    {
    }
...
#nullable enable
    public async Task<FullVmConfiguration?> GetAsync(
        Action<ConfigRequestBuilderGetRequestConfiguration>? requestConfiguration = default,
        CancellationToken cancellationToken = default)
    {
#nullable restore
#else
        public async Task<FullVmConfiguration> GetAsync(Action<ConfigRequestBuilderGetRequestConfiguration> requestConfiguration
 = default, CancellationToken cancellationToken = default) {
#endif
        var requestInfo = this.ToGetRequestInformation(requestConfiguration);
        return await this.RequestAdapter.SendAsync<FullVmConfiguration>(requestInfo,
            FullVmConfiguration.CreateFromDiscriminatorValue, default, cancellationToken);
    }
...
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<ConfigRequestBuilderGetRequestConfiguration> requestConfiguration
 = default) {
#endif
