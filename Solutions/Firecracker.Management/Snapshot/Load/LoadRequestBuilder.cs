...
namespace Firecracker.Management.Snapshot.Load
{
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="global::Firecracker.Management.Snapshot.Load.LoadRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task PutAsync(global::Firecracker.Management.Models.SnapshotLoadParams body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task PutAsync(global::Firecracker.Management.Models.SnapshotLoadParams body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPutRequestInformation(global::Firecracker.Management.Models.SnapshotLoadParams body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPutRequestInformation(global::Firecracker.Management.Models.SnapshotLoadParams body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::Firecracker.Management.Snapshot.Load.LoadRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Firecracker.Management.Snapshot.Load.LoadRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Firecracker.Management.Snapshot.Load.LoadRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
