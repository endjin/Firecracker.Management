...
namespace Firecracker.Management.VersionNamespace
{
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="global::Firecracker.Management.VersionNamespace.VersionRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task<global::Firecracker.Management.Models.FirecrackerVersion?> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Firecracker.Management.Models.FirecrackerVersion> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<global::Firecracker.Management.Models.FirecrackerVersion>(requestInfo, global::Firecracker.Management.Models.FirecrackerVersion.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// Gets the Firecracker version.
        /// </summary>
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::Firecracker.Management.VersionNamespace.VersionRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Firecracker.Management.VersionNamespace.VersionRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Firecracker.Management.VersionNamespace.VersionRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
